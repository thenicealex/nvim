...
map("n", "<localleader>-", "<C-W>s", { desc = "Split window below", remap = true })
map("n", "<localleader>|", "<C-W>v", { desc = "Split window right", remap = true })
...
map("n", "<localleader>bb", "<cmd>BufferLinePick<cr>", { desc = "Go buffer" })
map("n", "<localleader>bp", "<cmd>BufferLineTogglePin<cr>", { desc = "Buffer pin" })
